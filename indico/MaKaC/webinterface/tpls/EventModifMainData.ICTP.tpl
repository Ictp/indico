...
<tr>
    <td class="dataCaptionTD">
        <span class="dataCaptionFormat sis">${ _("Title")}*</span>
    </td>
...
<tr>
    <td class="dataCaptionTD">
        <span class="dataCaptionFormat sis">${ _("Place")}*</span>
    </td>
...
<tr>
    <td class="dataCaptionTD">
        <span class="dataCaptionFormat sis">${ _("Start/End date")}*</span>
    </td>
    <td class="blacktext">
...
<tr>
    <td class="dataCaptionTD">
        <span class="dataCaptionFormat sis">${ _("Roles")}*</span>
    </td>
    <td class="blacktext">
...
<tr>
    <td class="dataCaptionTD">
        <span class="dataCaptionFormat sis">${ _("Keywords")}*</span>
    </td>
    <td class="blacktext">
...
% if evtType == 'conference':
    ...
    $E('inPlaceEditRoles').set(new GroupingWidget('event.main.changeRoles', {'conference':'${ conferenceId }'}, ${jsonEncode(roles)}, true, null, false, null).draw());
% endif
