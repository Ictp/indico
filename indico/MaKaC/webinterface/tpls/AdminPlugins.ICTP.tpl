...
<table style="width: 100%; margin-top: 2em;">
    ...
    % if PluginType.getOptions() is not None and len(PluginType.getOptions()) > 0:
         <%include file="AdminPluginsOptionList.ICTP.tpl" args="Object = PluginType, ObjectType = 'PluginType', Favorites = Favorites, Index = 0, rbActive = rbActive, baseURL = baseURL"/>
    % endif
    ...
    <div>
        ...
        <div id="${plugin.getName()}OptionsDiv" style="display:none;">
            % if plugin.hasAnyOptions():
                <%include file="AdminPluginsOptionList.ICTP.tpl" args="Object = plugin, ObjectType = 'Plugin', Favorites = Favorites, Index = i, rbActive = rbActive, baseURL = baseURL"/>
