    ...
    <div class="topBar" style="margin-bottom: 10px">
        <div class="content smaller">
            <span id="futureEventsShow">
                There are events in the <em>future</em>.
                <span class="fakeLink futureEventsLink">Show them.</span>
            </span>
            <span id="futureEventsHide" style="display: none;">
                <span class="fakeLink futureEventsLink">Hide</span> the events in the future 
            </span>
        </div>
    </div>
    <div id="futureEvents" style="display: none;">
        <%include file="ConferenceListEvents.ICTP.tpl" args="items=futureItems, aw=self_._aw, conferenceDisplayURLGen=conferenceDisplayURLGen"/>
    </div>
    % endif
    <div>
        <%include file="ConferenceListEvents.ICTP.tpl" args="items=presentItems, aw=self_._aw, conferenceDisplayURLGen=conferenceDisplayURLGen"/>
    </div>
