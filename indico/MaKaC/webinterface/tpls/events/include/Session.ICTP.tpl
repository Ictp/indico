...
<li class="meetingSession">
    <span class="containerTitle confModifPadding">
        ...
        % if item.getTitle() != "" and item.getTitle() != session.getTitle() and session.getTitle() != 'notitle' and item.getTitle().find("#") == -1:
    ...
    <table class="sessionDetails">
        ...
        <tr>
            ...
            % for material in session.getAllMaterialList():
                ...
                <%include file="Material.ICTP.tpl" args="material=material, sessionId=session.getId()"/>
                % endif
            % endfor
            </td>
        </tr>
            ...
            <%
                if subitem.__class__.__name__ != 'BreakTimeSchEntry':
                    ...
                    if not subitem.canView(accessWrapper):
                        continue
            %>
            <%include file="${getItemType(subitem)}.ICTP.tpl"
