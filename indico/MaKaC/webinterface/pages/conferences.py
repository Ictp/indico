...
class WConfDisplayFrame(wcomponents.WTemplated):
    ...
    def getLogoPath(self, key):
        ...
        p = htdocsDir + "/css/ICTP/images/sponsor-logo/" + key
...
"exystence":{"url":"http://www.complexityscience.org","country":""},
...
"cec":{"url":"","country":""},
"elettronica quantistica":{"url":"","country":""},
...
"programa bicentenario de ciencia":{"url":"","country":""},
...
"consortium of the americas for interdisciplinary science":{"url":"http://consortium.unm.edu/","country":"USA"},
...
"icgeg":{"url":"http://www.icgeb.org/home.html","country":"Italy"},
...
"wrcp":{"url":"http://www.wcrp-climate.org/","country":"Switzerland"},
...
"ministry of earth sciences":{"url":"http://dod.nic.in/","country":"India"},
"intel biomat":{"url":"http://www.esf.org/home.html","country":"France"},
...
"american physical society":{"url":"www.aps.org/","country":"USA"},
...
"lammps":{"url":"","country":""},
"developers workshop and symposium":{"url":"","country":""},
                    ...
                    for elem in cosp:
                        for av in available_sponsors.keys():                   
                            if str(elem["familyName"]).lower().find(av) > -1:
                                ...
                                if self.getLogoPath(av):
                                    img = Image(filename=self.getLogoPath(av))
